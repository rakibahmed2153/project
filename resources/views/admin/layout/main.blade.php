                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Scout</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addscout')}}"><i class="fa fa-pencil"></i>Create Scout</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.scoutlist')}}"><i class="fa fa-th"></i>Scout List</a>
                                    </li>
                                    
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>User</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.adduser')}}"><i class="fa fa-pencil"></i>Add New User</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.userlist')}}"><i class="fa fa-file-text"></i>User List</a>
                                    </li>
            
                                </ul>
                            </li>
                            <li>
                                <a href="{{route('admin.requestlist')}}"><i class="fa fa-th-list"></i> Request List</a>
                            </li>
                            <li>
                                <a href="{{route('admin.placereqlist')}}"><i class="fa fa-th-list"></i>Publish Request</a>
                            </li>
                            <li>
                                <a href="{{route('admin.showplacelist')}}"><i class="fa fa-th-list"></i>Show Place</a>
                                
                            </li>
                            
                            <li>
                                <a href="{{route('admin.usercomment')}}"><i class="fa fa-th-list"></i>User Comment</a>
