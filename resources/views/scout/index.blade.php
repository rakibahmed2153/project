                            ...
                            <div class="dash-tile dash-tile-ocean clearfix animation-pullDown">
                                <div class="dash-tile-header">
                                    <div class="dash-tile-options">
                                        <div class="btn-group">
                                            <a href="{{route('scout.addplace')}}" class="btn btn-default" data-toggle="tooltip" title="Add Place"><i class="fa fa-cog"></i></a>
                                            <a href="{{route('scout.placelist')}}" class="btn btn-default" data-toggle="tooltip" title="Place List"><i class="fa fa-th"></i></a>
                                        </div>
                                    </div>
                                    Places
                                </div>
                            ...
                            <div class="dash-tile dash-tile-leaf clearfix animation-pullDown">
                                <div class="dash-tile-header">
                                    <span class="dash-tile-options">
                                        ...
                                        <a href="{{route('scout.profile')}}" class="btn btn-default" data-toggle="tooltip" title="Profile"><i class="fa fa-th"></i></a>
                                    </span>
                                    Profile
                                </div>
                                <div class="dash-tile-icon"><i class="fa fa-users"></i></div>
