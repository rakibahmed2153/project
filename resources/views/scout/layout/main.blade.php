    ...
    <body>
        ...
        <div id="page-container">
            ...
            <header class="navbar navbar-inverse">
                ...
                <!-- Logo -->
                <a href="{{route('scout.index')}}" class="navbar-brand">U{{session('type')}}</a>
                    ...
                    <li class="dropdown pull-right dropdown-user" style="margin-top: -30px; margin-right: 20px;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <a href="{{route('scout.profile')}}" role="button" data-toggle="modal"><i class="fa fa-user"></i> User Profile</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                             ...
                             <li>
                                <a href="{{route('scout.index')}}" class="active"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>        
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i> Places</a>
                                <ul>
                                    <li>
                                        <a href="{{route('scout.addplace')}}"><i class="fa fa-pencil"></i>Create Places</a>
                                    </li>
                                    <li>
                                        <a href="{{route('scout.placelist')}}"><i class="fa fa-th"></i>Place List</a>
                                    </li>
                            ...
                            <li>
                                <a href="{{route('scout.profile')}}"><i class="fa fa-th-list"></i>Manage Profile</a>
                            </li>
                            <li>
                                <a href="{{route('scout.cngpassword')}}"><i class="fa fa-th-list"></i>Change Password</a>
                            </li>
